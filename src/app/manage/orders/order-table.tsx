...
import { getVietnameseOrderStatus, handleErrorApi, cn } from '@/app/lib/utils'
...
export default function OrderTable() {
  ...
  useEffect(() => {
    ...
    function onUpdateOrder(data: UpdateOrderResType['data']) {
      ...
      toast.success(
        `Món ăn ${name} (SL: ${quantity}) vừa được cập nhật sang trạng thái "${getVietnameseOrderStatus(data.status)}"`
      )
      refetch()
    }
