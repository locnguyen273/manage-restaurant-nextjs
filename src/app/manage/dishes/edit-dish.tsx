...
import { getVietnameseDishStatus, handleErrorApi } from '@/app/lib/utils'
...
export default function EditDish({
  ...
  const onSubmit = async (value: UpdateDishBodyType) => {
    ...
    try {
      let body: UpdateDishBodyType & { id: number } = { id: id as number, ...value }
      if (file) {
